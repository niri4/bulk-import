...
RSpec.describe EmployeesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all employees as @employees" do
      ...
      get :index, {}
      expect(assigns(:employees).last).to eq([employee].last)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested employee" do
        employee = Employee.create! valid_attributes
        put :update, params: {id: employee, employee: new_attributes}
        employee.reload
        expect(assigns(:employee).name).to eq(new_attributes[:name])
      end

      it "assigns the requested employee as @employee" do
        employee = Employee.create! valid_attributes
        put :update, params: {id: employee, employee: valid_attributes}
        expect(assigns(:employee)).to eq(employee)
      end
    ...
    describe "with invalid params" do
      it "assigns the employee as @employee" do
        employee = Employee.create! valid_attributes
        put :update, params: {id: employee, employee: invalid_attributes}
        expect(assigns(:employee)).to eq(employee)
      end
